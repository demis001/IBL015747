testForGOSourceMismatches <- function(){
  require("GO.db")
  require("annotate")
  require("IBL015747.db")
  g = Lkeys(GOTERM)
  m = Rkeys(getAnnMap('GO2PROBE', gsub(".db$","","IBL015747.db")))
...
getPkgDate <-function(){
  require("IBL015747.db")
  dbmeta(eval(call(name = paste(gsub(".db$","","IBL015747.db"),
...
getProbes <- function(){
    require("IBL015747.db")
    as.numeric(dbGetQuery(dbconn(IBL015747.db),
